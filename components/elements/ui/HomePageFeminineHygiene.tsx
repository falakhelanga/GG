...
const HomePageFeminineHygiene = ({
  ...
  return (
    <div className="md:bg-[url(/images/desktop_fem_hyg_bg.png)] relative  bg-cover bg-center  h-auto relative bg-no-repeat md:overflow-hidden mb-1">
      ...
      /> */}
        ...
        "
              ...
              <div className="text-center my-8">
                <MarkDown className="text-lg">{quoteText}</MarkDown>{" "}
                {/* <p className="text-lg">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                </p> */}
              </div>
              <MarkDown className="text-center mb-8 text-sm">
                {bodyCopyText}
              </MarkDown>
            </div>
