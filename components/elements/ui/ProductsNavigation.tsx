      ...
      <ContentWrap className=" flex flex-col items-center ">
        <div className="flex flex-col md:w-[50%]">
          <div className="overflow-hidden flex flex-col uppercase w-full   relative items-center max-sm:text-center text-black md:text-lg text-md border-b border-b-green  ">
            <div className="flex max-sm:gap-8 md:gap-[0rem] gap-4 ">
              {links.map((item, idx) => {
                return (
                  <Link
                    key={item.name}
                    ...
                    className={`hover:text-green relative  md:px-[4rem] z-[10] md:hover:translate-y-[3px] transition-all ease-in transition-duration-[3000ms] ${
