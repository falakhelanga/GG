    ...
    <div>
      ...
      {reviews.length > 3 && (
        <div className=" relative">
          <div
            className=" absolute top-[40%] md:left-[0rem] -left-6 z-[3] cursor-pointer  rounded-full h-7 w-7 flex items-center justify-center "
          ...
          <div
            ...
            className=" absolute top-[40%] md:right-[0rem] -right-6 z-[3] cursor-pointer  rounded-full h-7 w-7 flex items-center justify-center"
          >
